...
<body>
	...
	<table>
		<tr>
			<td class="data">Leerlingcode</td>
			<td class="data">Leerling</td>
			<td class="data">Klascode</td>
		</tr>
		<c:forEach var="leerling" items="${leerlingenLijst}">
			<tr>
				...
				<td class="data">${leerling.leerlingnaam}</td>
				<td class="data">${leerling.klascode}</td>
			</tr>
		</c:forEach>
	</table>
	</div>
